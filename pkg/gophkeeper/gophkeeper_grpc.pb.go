...
type KeeperServiceClient interface {
	...
	SendData(ctx context.Context, opts ...grpc.CallOption) (KeeperService_SendDataClient, error)
	ReceiveData(ctx context.Context, in *Entity, opts ...grpc.CallOption) (KeeperService_ReceiveDataClient, error)
...
func (c *keeperServiceClient) SendData(ctx context.Context, opts ...grpc.CallOption) (KeeperService_SendDataClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &KeeperService_ServiceDesc.Streams[0], KeeperService_SendData_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &keeperServiceSendDataClient{ClientStream: stream}
	return x, nil
}

type KeeperService_SendDataClient interface {
	Send(*Chunk) error
	CloseAndRecv() (*Empty, error)
	grpc.ClientStream
}

type keeperServiceSendDataClient struct {
	grpc.ClientStream
}

func (x *keeperServiceSendDataClient) Send(m *Chunk) error {
	return x.ClientStream.SendMsg(m)
}

func (x *keeperServiceSendDataClient) CloseAndRecv() (*Empty, error) {
...
func (c *keeperServiceClient) ReceiveData(ctx context.Context, in *Entity, opts ...grpc.CallOption) (KeeperService_ReceiveDataClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &KeeperService_ServiceDesc.Streams[1], KeeperService_ReceiveData_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &keeperServiceReceiveDataClient{ClientStream: stream}
...
type KeeperService_ReceiveDataClient interface {
	Recv() (*Chunk, error)
	grpc.ClientStream
}

type keeperServiceReceiveDataClient struct {
	grpc.ClientStream
}

func (x *keeperServiceReceiveDataClient) Recv() (*Chunk, error) {
	m := new(Chunk)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type KeeperServiceServer interface {
	...
	SendData(KeeperService_SendDataServer) error
	ReceiveData(*Entity, KeeperService_ReceiveDataServer) error
...
func (UnimplementedKeeperServiceServer) SendData(KeeperService_SendDataServer) error {
	return status.Errorf(codes.Unimplemented, "method SendData not implemented")
}
func (UnimplementedKeeperServiceServer) ReceiveData(*Entity, KeeperService_ReceiveDataServer) error {
...
func _KeeperService_SendData_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(KeeperServiceServer).SendData(&keeperServiceSendDataServer{ServerStream: stream})
}

type KeeperService_SendDataServer interface {
	SendAndClose(*Empty) error
	Recv() (*Chunk, error)
	grpc.ServerStream
}

type keeperServiceSendDataServer struct {
	grpc.ServerStream
}

func (x *keeperServiceSendDataServer) SendAndClose(m *Empty) error {
	return x.ServerStream.SendMsg(m)
}

func (x *keeperServiceSendDataServer) Recv() (*Chunk, error) {
	m := new(Chunk)
...
func _KeeperService_ReceiveData_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(KeeperServiceServer).ReceiveData(m, &keeperServiceReceiveDataServer{ServerStream: stream})
}

type KeeperService_ReceiveDataServer interface {
	Send(*Chunk) error
	grpc.ServerStream
}

type keeperServiceReceiveDataServer struct {
	grpc.ServerStream
}

func (x *keeperServiceReceiveDataServer) Send(m *Chunk) error {
	return x.ServerStream.SendMsg(m)
}
